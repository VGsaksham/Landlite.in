...
export default function Navbar() {
  ...
  const toggleMobileMenu = () => {
    console.log("Toggle mobile menu. Current state:", isMobileMenuOpen, "New state:", !isMobileMenuOpen);
    const newState = !isMobileMenuOpen;
    setIsMobileMenuOpen(newState);
    // Add/remove mobile-menu-open class directly on body
    if (newState) {
  ...
  return (
    <>
      ...
      {/* Make sure MobileNav is always rendered */}
      <MobileNav 
